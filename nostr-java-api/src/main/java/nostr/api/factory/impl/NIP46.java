...
public class NIP46 {
    ...
    public static class NostrConnectEventFactory extends EventFactory<NostrConnectEvent> {
        ...
        public NostrConnectEventFactory(@NonNull nostr.api.NIP46.Request request, @NonNull IIdentity sender, @NonNull PublicKey recipient) {
        ...
        public NostrConnectEventFactory(@NonNull nostr.api.NIP46.Response response, @NonNull IIdentity sender, @NonNull PublicKey recipient) {
