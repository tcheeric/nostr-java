...
import nostr.api.factory.impl.NIP01Nick.*;
 ...
 * @author eric
 */
public class NIP01Nick extends Nostr {
     ...
     */
    public static TextNoteEventNick createTextNoteEvent(@NonNull String content) {
        return new TextNoteEventFactory(content).create();
    }

    public static TextNoteEventNick createTextNoteEvent(@NonNull IIdentity sender, @NonNull String content) {
     ...
     */
    public static TextNoteEventNick createTextNoteEvent(@NonNull List<BaseTag> tags, @NonNull String content) {
        return new TextNoteEventFactory(tags, content).create();
    }

    public static TextNoteEventNick createTextNoteEvent(@NonNull IIdentity sender, @NonNull List<BaseTag> tags, @NonNull String content) {
...
//  TODO: revisit
//    public static MetadataEventNick createMetadataEvent(@NonNull UserProfile profile) {
//        return new MetadataEventFactory(profile).create();
//    }

    public static MetadataEventNick createMetadataEvent(@NonNull IIdentity sender, @NonNull UserProfile profile) {
     ...
     * @return
     */
    public static ParameterizedReplaceableEventNick createParameterizedReplaceableEvent(@NonNull Integer kind, String comment) {
     ...
     * @return
     */
    public static ParameterizedReplaceableEventNick createParameterizedReplaceableEvent(@NonNull List<BaseTag> tags, @NonNull Integer kind, String comment) {
