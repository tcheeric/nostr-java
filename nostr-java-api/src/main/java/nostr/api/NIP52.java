...
public class NIP52 extends EventNostr {
    ...
    public static GenericTag createStartTag(@NonNull Long start) {
        return new GenericTagFactory(Constants.Tag.START_CODE, start.toString()).create();
    }

    public static GenericTag createEndTag(@NonNull Long end) {
        return new GenericTagFactory(Constants.Tag.END_CODE, end.toString()).create();
    }

    public static GenericTag createStartTzidTag(@NonNull String startTzid) {
        return new GenericTagFactory(Constants.Tag.START_TZID_CODE, startTzid).create();
    }

    public static GenericTag createEndTzidTag(@NonNull String endTzid) {
        return new GenericTagFactory(Constants.Tag.END_TZID_CODE, endTzid).create();
    }

    public static GenericTag createFreeBusyTag(@NonNull String fb) {
        return new GenericTagFactory(Constants.Tag.FREE_BUSY_CODE, fb).create();
    }
