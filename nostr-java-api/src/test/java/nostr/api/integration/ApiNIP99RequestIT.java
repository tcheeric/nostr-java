...
class ApiNIP99RequestIT extends BaseRelayIntegrationTest {
    ...
    void testNIP99ClassifiedListingPreRequest() throws IOException {
        System.out.println("testNIP99ClassifiedListingPreRequest");
        ...
        List<String> eventResponses = springWebSocketClient.send(eventMessage).collectList().block();
        ...
        List<String> reqResponses = springWebSocketClient.send(reqJson).collectList().block();
