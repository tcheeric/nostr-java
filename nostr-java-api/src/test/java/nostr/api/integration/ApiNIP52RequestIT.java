...
class ApiNIP52RequestIT extends BaseRelayIntegrationTest {
  ...
  private static final String UUID_CALENDAR_TIME_BASED_EVENT_TEST =
  ...
  public static final String P1_TAG_HEX =
      "444d79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984";
  public static final String P1_ROLE = "PAYER";
  public static final String P2_ROLE = "PAYEE";

  public static final String P2_TAG_HEX =
      "555d79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984";
  ...
  void testNIP99CalendarContentPreRequest() throws Exception {
    ...
    CalendarContent<BaseTag> calendarContent =
        new CalendarContent<>(
            new IdentifierTag(UUID_CALENDAR_TIME_BASED_EVENT_TEST), TITLE, Long.valueOf(START));
    ...
    try (SpringWebSocketClient springWebSocketEventClient =
      ...
      String eventResponse =
          springWebSocketEventClient.send(eventMessage).stream().findFirst().orElseThrow();
    ...
    try (SpringWebSocketClient springWebSocketRequestClient =
      ...
      String reqResponse =
          springWebSocketRequestClient.send(reqJson).stream().findFirst().orElseThrow();
