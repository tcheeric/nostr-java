...
public class NIP01Test {
    ...
    public void testGenerateSignValidateAndConvertTextNoteWithRecipient() {
        ...
        GenericTag recipientTag = NIP01.createPubKeyTag(recipient.getPublicKey());
    ...
    public void testGenerateSignValidateAndConvertMetadataEvent() throws MalformedURLException {
        ...
        String profileContent = "{\"nip05\":\"testuser@nos.tr\",\"name\":\"test user\",\"about\":\"This is a test user profile.\",\"picture\":\"https://example.com/profile.jpg\"}";
    ...
    public void testCreateEventTag() {
        ...
        GenericTag genericTag = NIP01.createEventTag(eventId);

        assertInstanceOf(GenericTag.class, genericTag, "The created tag should be a GenericTag.");
    ...
    public void testCreateIdentifierTag() {
        ...
        assertEquals(identifier, identifierTag.getId(), "The identifier should match the provided value.");
    }
    ...
    public void testCreateAddressTag() {
        ...
        assertEquals(identifier, addressTag.getIdentifierTag().getId(), "The identifier should match the provided value.");
    }
}
