...
/** Represents a 'v' vote tag (NIP-2112). */
@Builder
@Data
...
public class VoteTag extends BaseTag {
  ...
  public static VoteTag deserialize(@NonNull JsonNode node) {
  ...
  public static VoteTag updateFields(@NonNull GenericTag genericTag) {
    ...
    return new VoteTag(Integer.valueOf(genericTag.getAttributes().get(0).value().toString()));
  }
}
