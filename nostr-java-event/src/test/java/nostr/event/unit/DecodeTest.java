...
public class DecodeTest {
  ...
  public void decodeTest() throws JsonProcessingException {
    ...
    assertEquals(
        "28f2fc030e335d061f0b9d03ce0e2c7d1253e6fadb15d89bd47379a96b2c861a", eventImpl.getId());
    assertEquals(1, eventImpl.getKind());
    assertEquals(
        "2bed79f81439ff794cf5ac5f7bff9121e257f399829e472c7a14d3e86fe76984",
        eventImpl.getPubKey().toString());
    ...
    for (int i = 0; i < expectedTags.size(); i++) {
      ...
      if (expected instanceof EventTag expetedEventTag) {
        ...
        assertEquals(
            expetedEventTag.getRecommendedRelayUrl(), actualEventTag.getRecommendedRelayUrl());
        ...
        assertEquals(
            expectedPublicKeyTag.getPublicKey().toString(),
            actualPublicKeyTag.getPublicKey().toString());
      } else {
        fail();
      }
    }
