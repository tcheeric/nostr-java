...
public class JsonContentValidationTest {
  ...
  private static final PublicKey PUBKEY =
      new PublicKey("56adf01ca1aa9d6f1c35953833bbe6d99a0c85b73af222e6bd305b51f2749f6f");

  private static class TestChannelCreateEvent extends ChannelCreateEvent {
    public TestChannelCreateEvent(PublicKey pk, String content) {
      super(pk, content);
    }

    public void callValidateContent() {
      super.validateContent();
    }
  }

  private static class TestProductEvent extends CreateOrUpdateProductEvent {
    public TestProductEvent(PublicKey pk, List<nostr.event.BaseTag> tags, String content) {
      super(pk, tags, content);
    }
