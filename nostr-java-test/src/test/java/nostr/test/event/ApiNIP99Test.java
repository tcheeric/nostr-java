...
import static nostr.test.event.ClassifiedListingEventTest.CLASSIFIED_LISTING_SUMMARY;
import static nostr.test.event.ClassifiedListingEventTest.CLASSIFIED_LISTING_TITLE;
...
import static nostr.test.event.ClassifiedListingEventTest.PRICE_TAG;
...
class ApiNIP99Test implements Subscriber<String> {
  ...
  void testNIP99ClassifiedListingEvent() throws JsonProcessingException {
    ...
    ClassifiedListing classifiedListing = new ClassifiedListing(TITLE_CODE, SUMMARY_CODE, priceTag);
