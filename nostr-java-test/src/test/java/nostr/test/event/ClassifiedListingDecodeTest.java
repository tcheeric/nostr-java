...
public class ClassifiedListingDecodeTest {
  ...
  @Test
  void testClassifiedListingDecoding() throws JsonProcessingException {
    ClassifiedListingEvent classifiedListingEvent = new GenericEventDecoder<>(ClassifiedListingEvent.class).decode(strippedJson);
